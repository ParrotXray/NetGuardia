...
pub trait IdentityAuthRepo: UserRepo + UserGroupRepo + LoginAttemptRepo + Send + Sync {}

impl<T> IdentityAuthRepo for T where T: UserRepo + UserGroupRepo + LoginAttemptRepo + Send + Sync + ?Sized {}
